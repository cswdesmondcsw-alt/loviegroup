...
export interface ApiTenantTenant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    entity_label: Schema.Attribute.String & Schema.Attribute.Required;
    entity_type: Schema.Attribute.Enumeration<['user', 'provider']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    tenant_id: Schema.Attribute.UID<'username'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
